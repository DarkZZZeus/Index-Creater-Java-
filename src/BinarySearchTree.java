...
public class BinarySearchTree<AnyType extends Comparable<? super AnyType>>
{
    ...
    public String printTree() {
    	...
    	return printForest(root);
    	
    }
    
    private String printForest(BinaryNode<AnyType> x) {
    	String output = "";
    	...
    	if(x == null){
    		...
    		output += printForest(x.left);
    		output += printNode(x);
    		output += printForest(x.right);
    	}
    	 	
    	return output;  		
    }
    
    private String printNode(BinaryNode<AnyType> x) {
